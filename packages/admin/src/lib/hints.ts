...
export const HINTS: Hint[] = [
  // Global
  {
    ...
    body: 'Press Ctrl+Shift+/ to see all keyboard shortcuts available on this page.',
    priority: 100,
  ...
  // App settings
  {
    ...
    body: 'Set the default agent, project directory, and session config for this application.',
    priority: 60,
